              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form>
                  ...
                  <div className="text-center mt-6">
                    <button
                      className="w-full px-6 py-3 text-center text-white bg-indigo-600 rounded-md active:bg-blueGray-800 font-bold mr-1 mb-1 ease-linear transition-all duration-150"
                      type="button"
                    >
                      Sign In
                    </button>
